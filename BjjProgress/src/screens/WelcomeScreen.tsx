    ...
    <View className="flex-1 bg-[#0f172a]">
      ...
      <View className="flex-1 items-center justify-center p-8">
        ...
        <View className="items-center mb-12">
          ...
          <View className="bg-white/10 px-4 py-1.5 rounded-full border border-white/10 mb-4">
        ...
        <View className="w-full gap-4 mb-8">
          ...
          >
            <LinearGradient
              ...
              className="w-full py-4 rounded-2xl items-center border border-white/10"
            >
              <Text className="text-white font-lato-bold text-lg tracking-wide">
                Get Started
              </Text>
            </LinearGradient>
          </TouchableOpacity>
